...
public class PedidoTest {
    ...
    void setUp( ) throws Exception
    {
    	...
    	pedidoTest = new Pedido("Paula Carreño", "Carrera 9 con calle 85");
    	pedidoTest2 = new Pedido("Miguel Sierra", "Carrera 5 con calle 34");
    ...
    void testGenerarTextoFactura() {
    	...
    	String stringDatos = "Cliente: Paula Carreño \nDirección: Carrera 9 con calle 85\n----------------\n";
    	...
    	String stringDatos2 = "Cliente: Miguel Sierra\nDirección: Carrera 5 con calle 34\n----------------\n";
